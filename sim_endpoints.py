...
async def run_sims(request: Request, org: Optional[str] = 'MABL', lg: Optional[str] = '35', innings: Optional[int] = 7, sims: Optional[int] = 1, go: Optional[int] = 0, away_lineup: Optional[str] = '1781+304+876+1063+2019+1125+750+2043+484+376', away_pitcher: Optional[int] = 484, home_lineup: Optional[str] = '579+492+391+825+1632+495+1605+1978+509', home_pitcher: Optional[int] = 825):
    ...
    plyrs = make_projections(df[(df['Org']==org) & (df['League']==lg) & (df['Year']>2016)], 50)
    ...
    if go==0:
        ...
        away_pitcher = pit[(pit['Org']==org) & (pit['League']==lg) & (pit['Year']==yr)]['PID'].iloc[0]
        home_lineup = plyrs['PID'][:10].tolist()
        home_pitcher = pit[(pit['Org']==org) & (pit['League']==lg) & (pit['Year']==yr)]['PID'].iloc[1]
        game_log_away = ''
        game_log_home = ''
        ab_results_away = ['']
        ab_results_home = ['']
        ...
        home_pitcher_df = pit[(pit['PID']==home_pitcher) & (pit['Org']==org) & (pit['League']==lg) & (pit['Year']==yr)]
        away_pitcher_df = pit[(pit['PID']==away_pitcher) & (pit['Org']==org) & (pit['League']==lg) & (pit['Year']==yr)]
